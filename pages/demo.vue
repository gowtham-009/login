<template>
  <div>
      <div class="w-100 bg-indigo" :style="{ height: deviceHeight + 'px' }">
                  ...
                  <div v-show="show">
                      <v-card-text>
                        <div class="w-100 d-flex justify-center ga-2">
                           ...
                           <div class="level  bg-white d-flex justify-center align-center rounded-circle"><span class="text-black">6</span></div>
                            <div class="level  bg-white d-flex justify-center align-center rounded-circle"><span class="text-black">7</span></div>
                            <div class="level  bg-white d-flex justify-center align-center rounded-circle"><span class="text-black">8</span></div>
                        </div>
                      </v-card-text>
                  </div>
                  </v-expand-transition>
          ...
          <div class="w-100 bg-white rounded-t-xl d-flex justify-center align-center" :style="{ height: boxex2Height + 'px' }">
              <div class="w-100 pa-1 d-flex justify-center align-center">
                  <v-form class="w-100 pa-1 d-flex justify-center align-center ":style="{ height: form + 'px' }"   >
                     <div class="w-100 inputbox formbox" :style="{ height: form2 + 'px' }"   >
                      <div class="w-100  rounded-xl bg-grey-lighten-3" :style="{ height: forminner + 'px' }"  ></div>
                      <div class="w-100  rounded-xl bg-grey-lighten-3" :style="{ height: forminner + 'px' }"  >
                          <div class="w-100 d-flex justify-center align-center flex-column" :style="{ height: loginputbox1 + 'px' }" >
                            <div class="w-75">
                          ...
                          <div class="w-100 d-flex justify-center align-end justify-space-between pb-3 pa-2" :style="{ height: loginputbox2 + 'px' }" >
...
const form=ref(0)
const form2=ref(0)
const forminner=ref(0)
const loginputbox1=ref(0)
const loginputbox2=ref(0)
const toggleShow = () => {
...
if(window.innerWidth > 800){
  ...
  form.value= Math.floor(boxex2Height.value * 0.99); 
  form2.value= Math.floor(form.value * 0.99); 

  forminner.value= Math.floor(form.value * 0.97); 
   loginputbox1.value= Math.floor(forminner.value * 0.85);
   loginputbox2.value= Math.floor(forminner.value * 0.15);
